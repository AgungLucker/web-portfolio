    ...
    return (
      <div className="relative flex gap-8 group">
        ...
        <div className="flex flex-col items-center">
            <div className="w-4 h-4 rounded-full border-4 border-red-600 dark:border-red-400 bg-white dark:bg-gray-900 z-10 transition-transform duration-300 group-hover:scale-125"></div>
            {!isLast && <div className="w-1 h-full bg-gray-200 dark:bg-gray-600 transition-colors duration-300"></div>}
        </div>
